...
export { Heading as HeadingVE, Text as TextVE, MetaText as MetaTextVE } from './typography/typography-ve';
...
export { RadioGroup as RadioGroupVE, RadioButton as RadioButtonVE } from './radio-group/radio-group-ve';
export { Switch as SwitchVE, SwitchRoot as SwitchRootVE, SwitchThumb as SwitchThumbVE } from './switch/switch-ve';
export { Checkbox as CheckboxVE } from './checkbox/checkbox-ve';
export { SelectVE, SelectRootVE, SelectTriggerVE, SelectValueVE, SelectLabelVE, SelectContentVE, SelectItemVE } from './select/select-ve';
export { TabsVE, TabsRootVE, TabsListVE, TabsTriggerVE, TabsContentVE } from './tabs/tabs-ve';
export { AccordionVE, AccordionRootVE, AccordionItemVE, AccordionTriggerVE, AccordionContentVE } from './accordion/accordion-ve';
export { PopoverVE, PopoverRootVE, PopoverPortalVE, PopoverContentVE, PopoverTriggerVE, PopoverAnchorVE, PopoverCloseVE } from './popover/popover-ve';
export { DialogVE, DialogRoot, DialogContent, DialogOverlay, DialogPortal, DialogTrigger, DialogHeader, DialogBody, DialogFooter, DialogTitle, DialogDescription, DialogClose } from './dialog/dialog-ve';
export { DrawerVE, DrawerRoot, DrawerContent, DrawerTrigger, DrawerClose, DrawerCustomTrigger, DrawerScrim } from './drawer/drawer-ve';
export { CarouselVE, CarouselRootVE, CarouselHeaderVE, CarouselHeaderContentVE, CarouselHeaderActionsVE, CarouselTitleVE, CarouselPreviousButtonVE, CarouselNextButtonVE, CarouselContentVE, CarouselItemVE, CarouselFooterVE, CarouselDotsVE } from './carousel/carousel-ve';
export { Container as ContainerVE } from './container/container-ve';
export { TooltipVE, TooltipRootVE, TooltipPortalVE, TooltipProviderVE, TooltipContentVE, TooltipTriggerVE } from './tooltip/tooltip-ve';
...
export const MIGRATION_CONFIG = {
  useVanillaExtract: process.env.NODE_ENV === 'development' || 
                    process.env.WPDS_USE_VANILLA_EXTRACT === 'true' ||
                    typeof window !== 'undefined' && window.location?.search?.includes('ve=true'),
};
...
export async function getInputPasswordComponent() {
  if (MIGRATION_CONFIG.useVanillaExtract) {
    const { InputPasswordVE } = await import('./input-password/input-password-ve');
...
export async function getInputTextareaComponent() {
  if (MIGRATION_CONFIG.useVanillaExtract) {
    const { InputTextareaVE } = await import('./input-textarea/input-textarea-ve');
...
export async function getNavigationMenuComponent() {
  if (MIGRATION_CONFIG.useVanillaExtract) {
    const { NavigationMenuVE } = await import('./navigation-menu/navigation-menu-ve');
...
export async function getTheme() {
  if (MIGRATION_CONFIG.useVanillaExtract) {
    const { vars, lightThemeVE, darkThemeVE } = await import('./theme/vanilla-extract');
