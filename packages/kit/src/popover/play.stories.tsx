...
} as Meta<typeof Popover.Content>;
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const AnchorTemplate: StoryFn<any> = (args) => {
  const triggerRef = React.useRef(null);
  const [parentElement, setParentElement] = React.useState();
  React.useEffect(() => {
    triggerRef?.current &&
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const CloseButtonTemplate: StoryFn<any> = (args) => {
  const triggerRef = React.useRef(null);
  const [parentElement, setParentElement] = React.useState();
  React.useEffect(() => {
    triggerRef?.current &&
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const MenuTemplate: StoryFn<any> = () => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const FullPopover: StoryFn<any> = ({ side, align }) => (
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const EdgeAndCornerCasesTemplate: StoryFn<any> = () => {
  ecGlobalCss();
  return (
    <div
      className="ec-grid"
