...
- To represent our core product offerings.
  ...
  <Box css={{ position: "relative", paddingLeft: "$200" }}>
    ...
    >
<<<<<<<< HEAD:build.washingtonpost.com/docs/resources/guides/emoji-guide.mdx
      <Box role="listItem">If we need art to represent core product offerings, we should evaluate if the use case warrants creating custom art.</Box>
========
      <Box role="listItem">
        If we need art to represent core product offerings, we should evaluate if
        the use case warrants creating custom art.
      </Box>{" "}
>>>>>>>> 1e4b13e93732720a8b3b9fec451676e52a097b6b:build.washingtonpost.com/docs/resources/guides/emoji_guide.mdx
    </Box>
  </Box>
