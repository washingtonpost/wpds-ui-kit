...
Add the theme to your tailwind.config.js. It's strongly recommended to override the default theme to prevent the accidental use of Tailwind's variables and scales. Tailwind's [preflight](https://tailwindcss.com/docs/preflight) base styles should be disabled.
