...
ASCII art typed directly into a page or other content is not accessibile to screen readers.

However, screenshots of ASCII art with appropriate [alt text](/accessibility/guides/alt-text) included are okay.
...
Ensure clear error messages are provided so that users know when and how to correct their input.
