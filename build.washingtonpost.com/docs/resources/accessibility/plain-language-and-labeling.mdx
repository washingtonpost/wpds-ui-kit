...
Meaning of icons, buttons and other elements [should be labeled with visible text](https://uxdesign.cc/label-your-icons-e2bd57366d37) whenever possible. In all cases, interactive elements should have appropriate [aria-labels](/resources/accessibility/semantic-html#Labeling%20interactive%20elements) for screen reader users.
