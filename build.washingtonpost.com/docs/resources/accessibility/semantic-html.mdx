...
Someone who is using a screen reader may jump around the headings on a page to quickly scan content. Headings have a heirarchy: A page should have only one h1 corresponding to its title, and h2s are used for major subsections, h3s are for subsections of h2s and so on.
