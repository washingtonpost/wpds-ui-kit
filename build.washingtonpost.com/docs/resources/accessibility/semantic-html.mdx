...
Inspect one of our articles with the Chrome developer tools to find the landmarks. You can also open a [screen reader rotor](/resources/accessibility/screen-readers#VoiceOver%20(MacOC%20and%20iOS)) to view a list of landmarks.
