---
title: Text size, fonts and zoom
...
Avoid using unfamiliar fonts. These can be difficult to read. Additionally, writing in all caps or with irregular capitalization can make text harder to read, especailly for screen reader users.

Our [WPDS Foundations fonts](/foundations/typography#Font%20size) are good examples of legible fonts.
