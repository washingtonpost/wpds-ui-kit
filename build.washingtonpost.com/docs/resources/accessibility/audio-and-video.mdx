...
## Avoid auto-playing audio or video, and always provide option to pause, stop or hide it

Are there any videos/gifs/animations on the page? They should have an accessible pause, stop or hide button. Auto-playing video content in any situation is strongly discouraged.
