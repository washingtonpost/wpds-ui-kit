...
- **Confirm white text is never on a pure black background**<br />
  ...
  for many users with astigmitism. See [our guidance for avoiding halation](/resources/accessibility/color#Avoid%20white%20text%20on%20black%20backgrounds).
...
- **Confirm heading order is correct**<br />
  ...
  should be [ordered strictly by page heirarchy](/resources/accessibility/semantic-html#Heading%20order%20and%20page%20landmarks)
