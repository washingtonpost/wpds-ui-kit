...
- **Change browser zoom level**<br />
  Restore page zoom to 100%, but [increase the font size in your browser settings](/resources/accessibility/text-size-and-zoom#Text%20size)
...
- **Test with screen reader rotor**<br />
  Using [a screen reader](/resources/accessibility/screen-readers), open the rotor
