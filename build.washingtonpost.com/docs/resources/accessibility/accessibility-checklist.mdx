...
- **Ensure text is readable and in plain language**<br />
  Text should be no smaller than 12px and written in [plain language](/resources/accessibility/plain-language-and-labeling)
...
- **Clearly label interactive content**<br />
  ...
  appropriate aria-labels. See our [guidance on labeling for screen reader users](/resources/accessibility/heading-order#Labeling%20interactive%20elements). Avoid user prompts or notices that disappear automatically. If the content
