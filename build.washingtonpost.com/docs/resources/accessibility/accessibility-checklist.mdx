...
- **Navigate content with keyboard only**<br />
  ...
  styles](/resources/accessibility/keyboard-accessibility#Focus%20rings) and (b) that they are clickable with the enter key (links and buttons)
...
- **Test with screen reader linearly**<br />
  ...
  page from top to bottom. Ensure all visible text is read aloud with correct pronunciation and in a sensible
  order.
