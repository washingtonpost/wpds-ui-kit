...
<form action="/action_page.php">
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="1" style={{ display: "inline-block" }}>
      {" "}
      <b>Run the axe DevTools tests</b>
      <br />
      You can install the [axe DevTools Chrome Extension](https://chrome.google.com/webstore/detail/axe-devtools-web-accessib/lhdoppojpmngadmnindnejefpokejbdd?hl=en-US)
      and then use it on the page ([guide to using axe DevTools](https://www.youtube.com/watch?v=iRGB40c_YJc&t=36s)).
...
<form action="/action_page.php">
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="2" style={{ display: "inline-block" }}>
      {" "}
      <b>Ensure all images have alt text</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="3" style={{ display: "inline-block" }}>
      {" "}
      <b>Hide certain content from screen readers</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="4" style={{ display: "inline-block" }}>
      {" "}
      <b>Avoid auto-playing audio and video</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="4" style={{ display: "inline-block" }}>
      {" "}
      <b>Eliminate rapidly flashing content</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="5" style={{ display: "inline-block" }}>
      {" "}
      <b>Provide captions and transcripts</b>
      <br />
...
<form action="/action_page.php">
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="6" style={{ display: "inline-block" }}>
      {" "}
      <b>Confirm white text is never on a pure black background</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="6" style={{ display: "inline-block" }}>
      {" "}
      <b>Confirm black text is never on a pure white background</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="7" style={{ display: "inline-block" }}>
      {" "}
      <b>Ensure color contrast meets the WCAG AA standard</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="8" style={{ display: "inline-block" }}>
      {" "}
      <b>Check contrast for common forms of colorblindness</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="9" style={{ display: "inline-block" }}>
      {" "}
      <b>View the page in dark and light mode</b>
      <br />
...
<form action="/action_page.php">
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="10" style={{ display: "inline-block" }}>
      {" "}
      <b>Text should be written in plain language</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="10" style={{ display: "inline-block" }}>
      {" "}
      <b>Ensure non-English content is labeled as such</b>
      <br />
      ...
      means we need to set an additional attribute in the HTML, `dir="rtl`.
    </label>
  </div>
  <br />
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="11" style={{ display: "inline-block" }}>
      {" "}
      <b>Clearly label interactive content</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="12" style={{ display: "inline-block" }}>
      {" "}
      <b>Ensure users have safeguards</b>
      <br />
...
<form action="/action_page.php">
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="15" style={{ display: "inline-block" }}>
      {" "}
      <b>Navigate content with keyboard only</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="16" style={{ display: "inline-block" }}>
      {" "}
      <b>Confirm heading order is correct</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="17" style={{ display: "inline-block" }}>
      {" "}
      <b>Test with screen reader linearly</b>
      <br />
  ...
  <div style={{ display: "flex", alignItems: "flex-start" }}>
    ...
    <label for="18">
      {" "}
      <b>Test with screen reader rotor</b>
      <br />
