...
<Container>
  <Box css={{ display: "flex", justifyContent: "center", margin: "auto" }}>
    <InlineImage width={672} height={448} src="/images/caption-example.png" />
  </Box>
</Container>
<br />
<br />
...
<Container>
  <Box css={{ display: "flex", justifyContent: "center", margin: "auto" }}>
    <InlineImage width={672} height={448} src="/images/text-alt-text.png" />
  </Box>
</Container>
<br />
<br />
...
<Container>
  <Box css={{ display: "flex", justifyContent: "center", margin: "auto" }}>
    <InlineImage width={672} height={448} src="/images/data-viz-alt-text.png" />
  </Box>
</Container>
<br />
<br />
...
<Container>
  <Box css={{ display: "flex", justifyContent: "center", margin: "auto" }}>
    <InlineImage width={672} height={448} src="/images/graphic-alt-text.png" />
  </Box>
</Container>
<br />
<br />
