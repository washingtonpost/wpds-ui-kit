...
5. Write in plain language so that the alt text's meaning is clear. Avoid complicated words and sentence structures. Avoid jargon and idioms. We have [more guidance on plain language](/resources/accessibility/guides/plain-language-and-labeling).
