...
<Alert variant="info">
  <p>
    The hook is only available in the browser and will return <code>undefined</code> on the server.
  </p>
</Alert>
...
```jsx
import { useResponsiveScreenSize, screenSizesEnums, Dialog, Drawer } from '@washingtonpost/wpds-ui-kit';
