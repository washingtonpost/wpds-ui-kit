    ...
    >
      <Accordion.Root type={ACCORDION_TYPE.single} collapsible={true}>
        <Accordion.Item value={"item-1"}>
          <Accordion.Trigger css={{ background: theme.colors.gray700 }}>
            Here's some sample text for an accordion header item
          </Accordion.Trigger>
          <Accordion.Content css={{ background: theme.colors.gray700 }}>
  ...
  return (
    ...
    >
      <Accordion.Root type={ACCORDION_TYPE.single} collapsible={true}>
        <Accordion.Item value={"item-1"}>
          <Accordion.Trigger
            density={ACCORDION_DENSITY.loose}
            css={{ background: theme.colors.gray700 }}
          >
            Here's some sample text for an accordion header item
          </Accordion.Trigger>
