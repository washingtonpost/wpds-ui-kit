      ...
      >
        <FlexRow spaceBetween>
          ...
          <FlexRow>
            ...
            <InputLabel>{checked ? "Enabled" : "Disabled"}</InputLabel>
          </FlexRow>
        </FlexRow>
      </Card>
      <Card
      ...
      >
        <FlexRow spaceBetween>
          <div>
            ...
            <br />
            Enabling this setting will minimize the amount of non-essential
            motion our website uses.
          </div>
          <FlexRow>
            <Switch.Root
              id="prefers-reduced-motion"
              checked={checkedTwo}
              onCheckedChange={() => setCheckedTwo(!checkedTwo)}
            >
              <Switch.Thumb value="reduce" name="prefers-reduced-motion" />
            </Switch.Root>
            <InputLabel>{checkedTwo ? "Enabled" : "Disabled"}</InputLabel>
          </FlexRow>
        </FlexRow>
      </Card>
    </FlexColumn>
