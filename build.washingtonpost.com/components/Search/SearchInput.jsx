...
import { InputSearch, Box, Icon, Text, styled, Button, Dialog } from '@washingtonpost/wpds-ui-kit';
...
export const DocSearch = ({ placeholder = "Search documentation...", maxResults = 10 }) => {
            ...
            >
              ...
              {results && (
                <InputSearch.Popover portal={false} open={isOpen}>
                  {results.length > 0 ? (
                    <InputSearch.List css={{ maxHeight: '400px', overflowY: 'auto' }}>
